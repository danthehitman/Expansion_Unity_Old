...
public static class TextureGenerator {		
    ...
    public static Texture2D GetCloud1Texture(int width, int height, BaseTile[,] tiles)
	{
    ...
    public static Texture2D GetCloud2Texture(int width, int height, BaseTile[,] tiles)
    {
        var texture = new Texture2D(width, height);
        var pixels = new Color[width * height];
	...
	public static Texture2D GetBumpMap(int width, int height, BaseTile[,] tiles)
	{
		var texture = new Texture2D(width, height);
		var pixels = new Color[width * height];
	...
	public static Texture2D GetHeightMapTexture(int width, int height, BaseTile[,] tiles)
	{
		var texture = new Texture2D(width, height);
		var pixels = new Color[width * height];
...
//					pixels[x + y * width] = Color.black;
	...
	public static Texture2D GetHeatMapTexture(int width, int height, BaseTile[,] tiles)
	{
		var texture = new Texture2D(width, height);
		var pixels = new Color[width * height];
	...
	public static Texture2D GetMoistureMapTexture(int width, int height, BaseTile[,] tiles)
	{
		var texture = new Texture2D(width, height);
		var pixels = new Color[width * height];
	...
	public static Texture2D GetBiomeMapTexture(int width, int height, BaseTile[,] tiles, float coldest, float colder, float cold)
	{
		var texture = new Texture2D(width, height);
		var pixels = new Color[width * height];
